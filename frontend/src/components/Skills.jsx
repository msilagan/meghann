...
const skills = [
  ...
  { name: "Kubernetes", category: "Containers", icon: <SiKubernetes size={48} /> },
  { name: "Terraform", category: "Infrastructure", icon: <SiTerraform size={48} /> },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-6 w-full max-w-6xl">
        {skills.map((skill, idx) => (
          ...
          >
            ...
            <h3 className="text-indigo-400 text-2xl font-semibold mb-2">{skill.name}</h3>
