  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(255,255,255,0), rgba(249,168,212,0.6), rgba(96,165,250,0.6), rgba(255,255,255,0))",
        }}
      ></div>
      ...
      <footer className="mt-0 bg-white/25 dark:bg-black/10 backdrop-blur-sm py-6">
        ...
        <div className="text-center text-gray-400 text-sm mt-6">
          &copy; {new Date().getFullYear()} Made with 💗 by Meghann Silagan. All
          rights reserved.
        </div>
      </footer>
    </div>
